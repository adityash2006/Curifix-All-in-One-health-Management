...
import { LayoutDashboard, MessageSquare, Pill, FileText, User, Menu, TrendingUp, Plus, Settings2 } from 'lucide-react';
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white border-r border-gray-200 p-6">
        ...
        <nav className="space-y-1">
          ...
          <button className="flex items-center gap-3 w-full px-3 py-2.5 bg-rose-50 text-gray-900 rounded-lg text-left">
